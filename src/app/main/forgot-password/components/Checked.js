...
const Checked = () => {
  ...
  const checked = useSelector((state) => state.forgotPassword.email.checked);
        ...
        <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1 }}>
          <Card className="w-full max-w-384">
            <CardContent className="flex flex-col items-center justify-center p-16 sm:p-24 md:p-32">
              {/* <img className="w-128 m-32" src="assets/images/logo.svg" alt="logo" /> */}
              <svg
                width="30"
                height="33"
                viewBox="0 0 30 33"
              ...
              <div className="flex flex-col items-center justify-center pt-32 pb-24 text-16">
                <span className="font-normal">Please check your Email!</span>
              </div>

              <div className="flex flex-col items-center justify-center pt-32 pb-4 text-16">
                <span className="font-normal">If you have OTP</span>
              </div>
