...
function Chat(props) {
  ...
  function onMessageSubmit(ev) {
    ...
    // get time when message is submitted
  ...
  function connect() {
    ...
    stompClient.connect({}, function (frame) {
      ...
      stompClient.subscribe(
        `/chat-contact/userId/${userId}/chatId/${contactId}`,
        function (message) {
  ...
  console.log(`/chat-contact/userId/${userId}/chatId/${contactId}`);
  ...
  //   stompClient.send(
  //     `/app/chat/userId/${userId}/contactId/${contactId}`,
  //     {},
