...
const defaultValues = {
  // userId: 'baa88231-0ee6-4028-96d5-7f187e0f4cd5',
  message: '',
};
...
function CardComment(props) {
  ...
  function onSubmit(data) {
    props.onCommentAdd(CommentModel({ ...defaultValues, ...data }, userId));
    reset(defaultValues);
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex -mx-8">
      <Avatar className="w-32 h-32 mx-8" alt={user.username} src={user.photoURL} />
