...
function BoardList(props) {
  ...
  const listIdConvert = listId?.toString();
  ...
  return (
    <Draggable draggableId={listIdConvert} index={props.index} type="list">
      {(provided, snapshot) => (
          ...
          >
            ...
            <>
              <CardContent
                ...
                ref={contentScrollEl}
              >
                <Droppable droppableId={listIdConvert} type="card" direction="vertical">
                  {(_provided) => (
                    <div
